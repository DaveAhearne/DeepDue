...
Identify any officers whose appointment count is anomalously high. Most legitimate directors hold between 1 and 5 appointments. Counts above 10 are unusual and warrant scrutiny. Counts above 25 are strongly anomalous and may indicate a nominee director, a shell company network, or systematic fraud.
...
def make_pattern_detection_node(llm: LLMClient):
    async def node(state: InvestigationState):
        ...
        officer_appointments = {
            ...
            if ol in appointments and appointments[ol].total_results is not None
        }
